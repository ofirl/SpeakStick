...
export const AddWordModal = ({ libraryId, disabled }: AddWordModalProps) => {
  ...
  const { mutateAsync: updateWord, isPending } = useUpdateLibraryItems();
    ...
    <>
      ...
      >
        <Box sx={modalBoxStyle}>
          ...
          />
          <Button disabled={isPending} variant="contained" style={{ marginTop: "1rem", alignSelf: "end" }} onClick={onSave}>
