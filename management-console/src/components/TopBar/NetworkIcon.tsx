...
export const NetworkIcon = () => {
  ...
  const { mutateAsync: updateNetworkConfiguration, isPending: isConnectingToNetwork } = useUpdateNetworkConfiguration()

  const { data: networkStatus, isPending: isLoadingStatus } = useGetNetworkStatus()
